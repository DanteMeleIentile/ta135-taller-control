...
wind = (4 * K_ext(1) + 20 * K_ext(3) + 80) / K_ext(5);

fprintf("WINDUP = %.3f", wind);
fprintf('\nchi = %.6f, wn = %.6f, ts = %.6f, tr = %.6f, %.6f, %.6f};\n\n', chi, wn, ts, tr);
fprintf('\nconst float K[5] = {%.6f, %.6f, %.6f, %.6f, %.6f};\n\n', K_ext(1), K_ext(2), K_ext(3), K_ext(4), K_ext(5));
...
nombre_archivo = ['datos_impulso_465_46_125_A'];
