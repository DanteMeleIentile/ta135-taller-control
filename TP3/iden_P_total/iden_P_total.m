...
%obtengo los datos
t_real_6        = out.tout;
raw_ang_6       = out.angle_barra;
raw_u_6         = out.servo; 
raw_dist_6      = out.dist;

indices_6 = (t_real_6 >= t_inicial) & (t_real_6 <= t_final);
indices = indices_6;
t_v_6   = t_real_6(indices);
ang_6   = raw_ang_6(indices);
u_6     = raw_u_6(indices);
dist_6  = raw_dist_6(indices);

figure;
plot(t_v_6, ang_6, 'b', 'LineWidth', 1.2); 
hold on; 
plot(t_v_6, dist_6, 'g', 'LineWidth', 1.5); 
grid on;
plot(t_v_6, u_6*0.03, 'r', 'LineWidth', 1.5); 
grid on;
...
plot(t_v_6, y_sim_s, 'r--', 'LineWidth', 1.5); hold on;
